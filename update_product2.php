...
$id=$_GET["achu"];
$edit=mysqli_query($con, "SELECT * FROM `product` WHERE id='$id'");
...
if(isset($_POST["submit"])){
  ...
  if($_FILES["img"]["tmp_name"]!="")
      ...
      mysqli_query($con, "UPDATE `product` SET `name`='$n',`price`='$p',`image`='$i' WHERE id='$id'");
    ...
    <ul class="nav">
      ...
      <li class="nav_item">
        ...
        <ul class="d-none">
          ...
          <li>
            <a href="#" class="sub_link">Update Product</a>
          </li>
          <li>
    ...
    <div class="testbox">
      <form action="update_product2.php" method="POST">
        ...
        <div class="item">
          ...
          <input id="number" type="text" name="number" value="<?php echo $row["price"]; ?>" required/>
        </div>
        <div class="item">
